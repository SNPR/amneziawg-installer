...
<details>
  ...
  <b>A:</b> Starting with v5.7.11, <code>MTU = 1280</code> is set automatically. To change it: edit the <code>MTU = &lt;value&gt;</code> line in the <code>[Interface]</code> section of <code>/etc/amnezia/amneziawg/awg0.conf</code> and in client <code>.conf</code> files. Restart the service. See <a href="#mtu-mobile-adv">MTU and Mobile Clients</a> for details.
</details>
...
Starting with v5.7.11, `MTU = 1280` is set automatically in both server and client configs.
...
**For installations before v5.7.11:**
